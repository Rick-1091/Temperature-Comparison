...
const zh = new Map(Object.entries({
  ...
  'How often did days settle in the ranges the market priced? Chapter 02 runs the same check on real New York data.': '实际结果有多常落在市场定价的区间里？第 02 章用纽约的真实数据做了同样的检验。',
  'Size the loss': '估算损失',
